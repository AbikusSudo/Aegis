...
object CrashHandler : Thread.UncaughtExceptionHandler {
    ...
    override fun uncaughtException(thread: Thread, throwable: Throwable) {
        ...
        Log.e("Aegis", "uncaughtException", throwable)

        val logFile = File.createTempFile("Aegis Crash Report ",
            ".log",
    ...
    fun buildReportHeader(): String {
        var report = ""
        report += "Aegis ${BuildConfig.VERSION_NAME} (${BuildConfig.VERSION_CODE}) ${BuildConfig.FLAVOR.uppercase()}\n"
